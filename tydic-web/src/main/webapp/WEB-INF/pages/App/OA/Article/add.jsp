                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="text" name="title" value="${articleInfo.title}" size="60">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            ...
                            <div style="display: inline-block; vertical-align: middle;">
                                <textarea name="content" style="width:784px;height:50px" data-toggle="kindeditor">${articleInfo.content }</textarea>
                            </div>
                        </td>
                    </tr>
                </tbody>
